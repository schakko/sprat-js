...
sprat.ui.datetime = {
	...
	/**
	 * Convert input with given inputFormat to formatOutput
	 * @param {string} input
	 * @param {string} formatInput
	 * @param {string} formatOutput 
	 * @param {boolean} isInputUtc
	...
	init : function(_options) {
		if (!$.isFunction(moment)) {
			throw "momentjs must be included";
		}
		...
		$.each(options.formats, function(idx, entry) {
			...
			$(inputSelector).each(function() {
				// backingField contains the real POST parameter
